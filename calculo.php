            ...
            if (!empty($termo_pesquisa)) {
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($resultado)) {
                        echo "<li><strong style='color: white;'>Nome: </span><span style='color: #ed563b;'>" . $row["nome"] . "</span><br>";
                        ...
                        echo "<span style='color: white;'>Filhos: </span><span style='color: #ed563b;'>" . $row["filhos"] . "<br>";
                        echo "<span style='color: white;'>Salario: </span><span style='color: #ed563b;'>R$ " . $row["salario"] . "</li>";
                        // Adicionar botão para calcular descontos
                        echo "<form method='POST' action='calcular_descontos.php'>";
                          echo "<input type='hidden' name='salario' value='" . $row["salario"] . "'>";
                         echo "<input type='hidden' name='filhos' value='" . $row["filhos"] . "'>";
                          echo "<button type='submit'>Calcular Descontos</button>";
                      echo "</form>";
